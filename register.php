...
<html>
<head>
	<title>Welcome to Musicmart!</title>
...
<body>
	...
	<div id="background">
			<div class="ml-auto">
				<button style="float:right; margin-top:5px; margin-right:5px; width:125px;" onclick="window.location.href='admin_login.php'" class="admin_button">Admin Login</button>
			</div>
